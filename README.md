...
### 支持的平台
 ...
 HarmonyOS NEXT | Last Version: 1.5.0-preview3 
 Mac | 敬请期待 
 Linux | 敬请期待 
### qplayer2-core 功能列表
...
{
  "dependencies": {
    "@qiniu/qplayer2-core": "^1.5.0-preview3",  //依赖 open harmony 中心仓
  }
}
```
...
1. demo 下载：https://sdk-release.qnsdk.com/qplayer2-demo-v1.5.0-preview3.hap

1.  电脑连接 harmony next 手机，执行下方命令安装 hap 包

   ```awk
   hdc install qplayer2-demo-v1.5.0-preview3.hap
   ```
